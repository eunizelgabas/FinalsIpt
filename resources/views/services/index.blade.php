                        ...
                        @foreach($service as $serv)
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-5 py-2 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">{{$serv->name}}</p>
                                </td>
                                ...
                                <td class="px-5 py-3 bg-white text-sm">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-gray-500 hover:scale-110">
                                            <a href="{{ url('/services/edit', $serv->id) }}"  title="Edit Service">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-gray-500 hover:scale-110">
                                            <form method="POST" action="{{ url('/services/'. $serv->id) }}">
                                                @csrf
                                                @method('DELETE')
                                            <button type="submit"  title="Delete Service" class="hover:border-red-400">
