...
<div class=" p-8 rounded-md w-full ">
    <div class=" flex items-center justify-between pb-6">
        <div>
            <h2 class="text-gray-600 font-semibold text-2xl">List of Appointment</h2>
                                    ...
                                    <td class="px-5 py-3 bg-white text-sm">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-4 mr-5 transform hover:text-purple-500 hover:scale-110">
                                                <form method="POST" action="{{ url('/appointment/accept/'. $app->id) }}">
                                                    @csrf
                                            <button type="submit"  title="Accept Appointment">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-gray-500 hover:scale-110">
                                                <form method="POST" action="{{ url('/appointment/cancel/'. $app->id) }}">
                                                    @csrf
                                                <button type="submit" title="Cancelled Appointment">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
